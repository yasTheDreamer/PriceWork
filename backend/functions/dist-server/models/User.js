"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports["default"] = void 0;function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var User = /*#__PURE__*/function () {
  function User(user) {_classCallCheck(this, User);
    if (!arguments.length) {
      this.User = {};
  ...
  }_createClass(User, [{ key: "withSalary", value: function withSalary(

    salary) {
      this.User.salary = salary;
      return this;
    } }, { key: "withJobTitle", value: function withJobTitle(
    ...
    state) {
      ...
      return this;
    } }, { key: "withZipCode", value: function withZipCode(

    zipCode) {
      this.User.address.zipCode = zipCode;
      return this;
    } }, { key: "withYearsOfExperience", value: function withYearsOfExperience(

    experience) {
      this.User.experience = experience;
      return this;
    } }, { key: "withEmailAdress", value: function withEmailAdress(

    email) {
      this.User.email = email;
      return this;
    } }, { key: "withSocialInfo1Login", value: function withSocialInfo1Login(

    socialLogin1) {
      this.User.socialLogin1 = socialLogin1;
      return this;
    } }, { key: "withSocialInfo2Login", value: function withSocialInfo2Login(
